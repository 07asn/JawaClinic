                ...
                <Grid container spacing={4} alignItems="center">
                    ...
                    <Grid item xs={12} md={6}>
                        <Grid container spacing={3}>
                            {[
                                { to: "/book-appointment", title: "Book an Appointment", description: "Click here to book your appointment today." },
                                { to: "/appointments", title: "Appointments", description: "Click here to check your appointments." },
                            ].map((item, index) => (
